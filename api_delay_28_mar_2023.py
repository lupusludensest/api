...
r = requests.get('https://httpbin.org/delay/3', timeout=3) # requests.exceptions.ReadTimeout: HTTPSConnectionPool(host='httpbin.org', port=443): Read timed out. (read timeout=3)
